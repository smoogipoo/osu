...
namespace osu.Game.Tests.Visual.Gameplay
{
    public class TestSceneSpectatorHost : PlayerTestScene
    {
        ...
        {
            AddUntilStep("spectator client sending frames", () => spectatorClient.UserStates.ContainsKey(dummy_user_id));
            AddAssert("spectator client sent correct ruleset", () => spectatorClient.UserStates[dummy_user_id].RulesetID == Ruleset.Value.OnlineID);
        }
