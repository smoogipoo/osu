...
namespace osu.Game.Tests.Arcade
{
    public class TestSceneRankedPlayArcade : RankedPlayTestScene
    {
        public override void SetUpSteps()
        {
            ...
            AddStep("connect aracade users", () =>
            {
                ArcadeClient.Connect(arcade_user_1);
                ArcadeClient.Connect(2, arcade_user_2);
            });
        ...
        [Test]
        public void TestCardPickStage()
        {
            AddStep("set card play phase", () => MultiplayerClient.RankedPlayChangeStage(RankedPlayStage.CardPlay).WaitSafely());
        }

        [Test]
        public void TestResultsStage()
        {
            setupResultsRequestHandler();
        ...
        private void setupResultsRequestHandler()
        {
        ...
        private static readonly ArcadeIdentity arcade_user_1 = new ArcadeIdentity
        {
            User = new ArcadeUser
            {
                UserId = 1,
                Username = "Arcade User 1",
        ...
        private static readonly ArcadeIdentity arcade_user_2 = new ArcadeIdentity
        {
            User = new ArcadeUser
            {
                UserId = 2,
                Username = "Arcade User 2",
