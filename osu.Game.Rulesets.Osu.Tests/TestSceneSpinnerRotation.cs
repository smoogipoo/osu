...
namespace osu.Game.Rulesets.Osu.Tests
{
    public partial class TestSceneSpinnerRotation : TestSceneOsuPlayer
    {
        ...
        public void TestSpinnerRewindingRotation()
        {
            ...
            AddAssert("is disc rotation absolute not almost 0", () => drawableSpinner.Result.AbsoluteRateAdjustedRotation, () => Is.Not.EqualTo(0).Within(100));
            ...
            AddAssert("is disc rotation absolute almost 0", () => drawableSpinner.Result.AbsoluteRateAdjustedRotation, () => Is.EqualTo(0).Within(100));
        }
        ...
        public void TestSpinnerMiddleRewindingRotation()
        {
            ...
            AddStep("retrieve cumulative disc rotation", () => finalCumulativeTrackerRotation = drawableSpinner.Result.AbsoluteRateAdjustedRotation);
            ...
            AddAssert("is cumulative rotation rewound",
                ...
                () => drawableSpinner.Result.AbsoluteRateAdjustedRotation, () => Is.EqualTo(finalCumulativeTrackerRotation / 2).Within(100));

            addSeekStep(spinner_start_time + 5000);
            AddAssert("is disc rotation almost same",
                () => drawableSpinner.RotationTracker.Rotation, () => Is.EqualTo(finalTrackerRotation).Within(trackerRotationTolerance));
            AddAssert("is cumulative rotation almost same",
                () => drawableSpinner.Result.AbsoluteRateAdjustedRotation, () => Is.EqualTo(finalCumulativeTrackerRotation).Within(100));
        }
        ...
        public void TestSpinnerNormalBonusRewinding()
        {
            ...
            AddAssert("player score matching expected bonus score", () =>
            {
                ...
                return totalScore == (int)(drawableSpinner.Result.AbsoluteRateAdjustedRotation / 360) * new SpinnerTick().CreateJudgement().MaxNumericResult;
            });
