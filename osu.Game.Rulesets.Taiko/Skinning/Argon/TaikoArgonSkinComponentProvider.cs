...
{
    public class TaikoArgonSkinComponentProvider : IDrawableProvider<SkinComponentLookup<HitResult>>,
                                                   IDrawableProvider<TaikoSkinComponentLookup>
    {
        private readonly ISkin skin;

        public TaikoArgonSkinComponentProvider(ISkin skin)
        {
            this.skin = skin;
        }
        ...
        public Drawable? Get(TaikoSkinComponentLookup lookup)
        {
            ...
            switch (lookup.Component)
            {
                ...
                case TaikoSkinComponents.TaikoExplosionOk:
                    return new ArgonHitExplosion(lookup.Component);
