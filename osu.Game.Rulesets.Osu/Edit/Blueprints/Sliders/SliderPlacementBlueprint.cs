...
namespace osu.Game.Rulesets.Osu.Edit.Blueprints.Sliders
{
    public class SliderPlacementBlueprint : PlacementBlueprint
    {
        ...
        private void updateSlider()
        {
            ...
            var unsnappedPath = new SliderPath
            {
                Type = newControlPoints.Length > 2 ? PathType.Bezier : PathType.Linear,
            ...
            HitObject.Path.Type = unsnappedPath.Type;
            HitObject.Path.ControlPoints = newControlPoints;
            HitObject.Path.ExpectedDistance = snappedDistance;
