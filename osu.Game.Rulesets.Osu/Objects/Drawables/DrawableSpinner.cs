    ...
    public partial class DrawableSpinner : DrawableOsuHitObject
    {
        ...
        public float Progress
        {
            get
            {
                ...
                return Math.Clamp(Result.AbsoluteRateAdjustedRotation / 360 / HitObject.SpinsRequired, 0, 1);
            }
        }
        ...
        protected override void UpdateAfterChildren()
        {
            ...
            if (Time.Current <= HitObject.EndTime)
                spmCalculator.SetRotation(Result.AbsoluteRateAdjustedRotation);
        ...
        private void updateBonusScore()
        {
            ...
            int spins = (int)(Result.AbsoluteRateAdjustedRotation / 360);
