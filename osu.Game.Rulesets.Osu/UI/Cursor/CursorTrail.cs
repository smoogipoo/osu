...
namespace osu.Game.Rulesets.Osu.UI.Cursor
{
    public class CursorTrail : Drawable, IRequireHighFrequencyMousePosition
    {
        ...
        public CursorTrail()
        {
            ...
            Layout.AddDependency(partSizeCache);
        }
        ...
        private readonly LayoutCached<Vector2> partSizeCache = new LayoutCached<Vector2>(Invalidation.DrawInfo | Invalidation.RequiredParentSizeToFit | Invalidation.Presence);
