...
namespace osu.Game.Screens.Edit.Compose.Components
{
    ...
    public partial class SelectionBox : CompositeDrawable
    {
        ...
        private void ensureButtonsOnScreen()
        {
            ...
            var parentQuad = Parent!.ScreenSpaceDrawQuad.AABBFloat.Shrink(ToLocalSpace(thisQuad.TopLeft.Xy + new Vector2(button_padding * 2)));
            ...
            if (topExcess < minHeight && bottomExcess < minHeight)
            {
                ...
                buttons.Y = Math.Min(0, ToLocalSpace(Parent!.ScreenSpaceDrawQuad.BottomLeft.Xy).Y - DrawHeight);
            }
            ...
            buttons.X += ToLocalSpace(thisQuad.TopLeft.Xy - new Vector2(Math.Min(0, leftExcess)) + new Vector2(Math.Min(0, rightExcess))).X;
        }
    }
}
