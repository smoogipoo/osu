...
namespace osu.Game.Rulesets.UI
{
        ...
        where T : struct
    {
        ...
        public override bool UpdateSubTree()
        {
            ...
            while (!updatedOnce || loops++ < max_catch_up_updates_per_frame && Clock.CurrentTime != parentClock.CurrentTime)
            {
                updateClock();
        ...
        private void updateClock()
        {
            ...
            clock.CurrentTime = !isAttached ? parentClock.CurrentTime : replayInputHandler.SetFrameFromTime(parentClock.CurrentTime);
        }
