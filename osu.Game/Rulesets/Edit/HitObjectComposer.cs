...
namespace osu.Game.Rulesets.Edit
{
        ...
        where TObject : HitObject
    {
                ...
                new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        drawableRulesetWrapper.CreatePlayfieldAdjustmentContainer()
                                              .WithChild(BlueprintContainer = CreateBlueprintContainer(drawableRulesetWrapper.Playfield))
                    }
                },
        ...
        /// </summary>
        /// <param name="playfield">Todo:</param>
        protected virtual ComposeBlueprintContainer CreateBlueprintContainer(Playfield playfield)
            => new ComposeBlueprintContainer(playfield);
